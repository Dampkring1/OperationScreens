...
?>
	<form name="form2" method="post" action="approvepost.php">
	<center>
	<legend> Feedback Approval page </legend>
	<a href="feedback.remove.php">Remove an Entry</a>
	<br>
	<br>
	Please Select the Feedback ID of the feedback you wish to approve!
	<br>
        Feedback ID:
        &nbsp;&nbsp;&nbsp;<?php
...
$sql = "SELECT id FROM custfeedback WHERE approved = 'no'";
...
<?php
   ...
   $sql = 'SELECT id, user, sdref, datetime, comment, engineer, company, customer FROM  `custfeedback` WHERE `approved` ="no" ORDER BY  `custfeedback`.`id` ASC  ';
