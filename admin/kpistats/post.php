<html>
<Head>
<META HTTP-EQUIV="refresh" CONTENT="1;URL=http://support2.localnet/operations/admin/kpistats/index.php">
</head>
...
$thsmonth=$_POST['thsmonth'];
// Insert data into mysql
$sql="UPDATE `operations`.`kpistats` SET  `lstmonth` = '$lstmonth', `thsmonth` = '$thsmonth' WHERE  `kpistats`.`indicators` ='$indicators'";
