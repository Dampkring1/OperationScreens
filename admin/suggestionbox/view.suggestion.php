...
$sql = 'SELECT title, description, benefits, datetime, value, employeeapp FROM  `suggestions`ORDER BY  `suggestions`.`value` DESC ';
 ...
 echo
   ...
   echo "<center><a href='add.suggestion.php'>Submit an Idea</a></center>";
   echo "<br>";
