...
<div class="col-md-12" style="min-height:500px;">
 <section>
                <div class="container">
	<form name="form2" method="post" action="managerpost.php">
	<center>
	<legend>Suggestion Backing page </legend>
	<a href='../index.php'>Go Back</a>
	<center> Please select the title of the Suggestion you would like to comment on </center>
	<br>
        Suggestion Title:
	<br>
        &nbsp;&nbsp;&nbsp;<?php
...
$sql = "SELECT * FROM  `suggestions` WHERE  `value` >=10";
...
<br>
<br>
<center>Manager Comment:</center>
<textarea rows="4" cols="100" name="managercom" required></textarea>
...
$sql="SELECT * FROM  `suggestions` WHERE  `value` >=10";
 ...
 echo
   ...
   echo "<center>Below is a list of Suggestions that have achieved more than 9 backers!</center>";
   echo $userQuery;
   echo "<br>";
   mysql_close($conn);
?>
