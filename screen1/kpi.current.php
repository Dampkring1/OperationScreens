...
<html>
<head>
    <META HTTP-EQUIV="refresh" CONTENT="120;URL=http://support2.localnet/operations/screen1/business.current.php">
...
<?php
 ...
 echo
   ...
   echo "<legend><center><h1>CURRENT KPI VOLUMES</h1></center></legend>";
   echo "<br>";
   mysql_close($conn);
?>
</center>
